...
Nessas avaliações os alunos deverão responder questões pré-definidas, utilizando [RMarkdown](https://rmarkdown.rstudio.com/) para a entrega das tarefas. Eu tenho materiais preparados sobre como iniciar a trabalhar com essa tecnologia ([link em inglês](https://github.com/mnunes/2nd-csds), [link em português](https://github.com/mnunes/Curso-RMarkdown)).
